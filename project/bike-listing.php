...
<title>e-Bike Reservation</title>
<!--Bootstrap -->
...
{  ?>
        <div class="product-listing-m gray-bg">
          <div class="product-listing-img"><img src="C:\xampp\htdocs\bikerental PHP\bikerental\assets\images"<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="Image" /> </a>
          </div>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Reserve a Bike </h5>
          </div>
