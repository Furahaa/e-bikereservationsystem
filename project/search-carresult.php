...
<title>e-Bike Reservation | Bike Listing</title>
<!--Bootstrap -->
...
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?> Bike Listings</span></p>
</div>
</div>
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price">Ksh<?php echo htmlentities($result->PricePerHour);?> Per Hour</p>
            <ul>
              <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->BatteryCapacity);?> seats</li>
              <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->PedalAssist);?> model</li>
              <li><i class="fa fa-car" aria-hidden="true"></i><?php echo htmlentities($result->Weight);?></li>
            </ul>
      ...
      <aside class="col-md-3 col-md-pull-9">
		...
		<?php }} ?>
							...
							<div class="form-group select">
								<select class="form-control" name="Battery">
									<option>Select Pedal Assist System</option>
		<option value="5 Levels">5 Levels </option>
		<option value="7 Levels">7 Levels</option>
								</select>
							</div>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa-solid fa-list" aria-hidden="true"></i> Recently Listed Bikes</h5>
          </div>
...
{  ?>
              ...
              <li class="gray-bg">
                <div class="recent_post_img"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="admin/img/vehicleimages/e-bee ebx.jpg<?php echo htmlentities($result->Vimage1);?>" alt="image"></a> </div>
                <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
                  <p class="widget_price">$<?php echo htmlentities($result->PricePerHour);?> Per Hour</p>
                </div>
              </li>
              <?php }} ?>
